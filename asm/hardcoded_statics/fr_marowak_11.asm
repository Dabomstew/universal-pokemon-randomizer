    .gba
    .thumb
    .open "pokefirered_rev1.gba", "pokefirered_rev1_marowak.gba", 0x08000000

    START_MAROWAK_BATTLE_HOOK_ADDR equ 0x0807F93E
    START_MAROWAK_BATTLE_CONTINUED equ 0x0807F954
