    .gba
    .thumb
    .open "pokeleafgreen_rev1.gba", "pokeleafgreen_rev1_marowak.gba", 0x08000000

    START_MAROWAK_BATTLE_HOOK_ADDR equ 0x0807F912
    START_MAROWAK_BATTLE_CONTINUED equ 0x0807F928
    CREATE_MON_WITH_GENDER_NATURE_LETTER equ 0x0803DE14
