...
public class SettingsConstants {
    ...
    public static final String USE_TIME_BASED_ENCOUNTERS = "useTimeBasedEncounters";
    public static final String BLOCK_WILD_LEGENDARIES = "blockWildLegendaries";
    ...
    public static final String TM_LEVEL_UP_MOVE_SANITY = "tmLevelUpMoveSanity";
    public static final String KEEP_FIELD_MOVE_TMS = "keepFieldMoveTMs";
    public static final String FULL_HM_COMPAT = "fullHMCompat";
    public static final String TMS_FORCE_GOOD_DAMAGING = "tmsForceGoodDamaging";
    public static final String TMS_GOOD_DAMAGING_PERCENT = "tmsGoodDamagingPercent";
    public static final String TMS_HMS_COMPATIBILITY_MOD = "tmsHmsCompatibilityMod";
    public static final String MOVE_TUTOR_MOVES_MOD = "moveTutorMovesMod";
    public static final String TUTOR_LEVEL_UP_MOVE_SANITY = "tutorLevelUpMoveSanity";
    public static final String KEEP_FIELD_MOVE_TUTORS = "keepFieldMoveTutors";
    public static final String TUTORS_FORCE_GOOD_DAMAGING = "tutorsForceGoodDamaging";
