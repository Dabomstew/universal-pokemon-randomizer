...
/*----------------------------------------------------------------------------*/
/*--  GenerationLimitDialog.java - a GUI interface to allow users to limit  --*/
/*--                               which Pokemon appear based on their      --*/
...
public class GenerationLimitDialog extends javax.swing.JDialog {
     ...
     */
    public GenerationLimitDialog(JFrame parent, GenRestrictions current, int generation) {
        super(parent, true);
        initComponents();
    ...
    private void initComponents() {
        ...
        includePokemonHeader.setFont(new java.awt.Font("Tahoma", Font.BOLD, 11)); // NOI18N
        ...
        gen1CB.addActionListener(evt -> gen1CBActionPerformed());

        gen2CB.setText(bundle.getString("GenerationLimitDialog.gen2CB.text")); // NOI18N
        gen2CB.addActionListener(evt -> gen2CBActionPerformed());

        gen3CB.setText(bundle.getString("GenerationLimitDialog.gen3CB.text")); // NOI18N
        gen3CB.addActionListener(evt -> gen3CBActionPerformed());

        gen4CB.setText(bundle.getString("GenerationLimitDialog.gen4CB.text")); // NOI18N
        gen4CB.addActionListener(evt -> gen4CBActionPerformed());

        gen5CB.setText(bundle.getString("GenerationLimitDialog.gen5CB.text")); // NOI18N
        gen5CB.addActionListener(evt -> gen5CBActionPerformed());

        relatedPokemonHeader.setFont(new java.awt.Font("Tahoma", Font.BOLD, 11)); // NOI18N
        ...
        warningRomHackLabel.setFont(new java.awt.Font("Tahoma", Font.BOLD, 11)); // NOI18N
    ...
    private void gen1CBActionPerformed() {// GEN-FIRST:event_gen1CBActionPerformed
        enableAndDisableBoxes();
    }// GEN-LAST:event_gen1CBActionPerformed

    private void gen2CBActionPerformed() {// GEN-FIRST:event_gen2CBActionPerformed
        enableAndDisableBoxes();
    }// GEN-LAST:event_gen2CBActionPerformed

    private void gen3CBActionPerformed() {// GEN-FIRST:event_gen3CBActionPerformed
        enableAndDisableBoxes();
    }// GEN-LAST:event_gen3CBActionPerformed

    private void gen4CBActionPerformed() {// GEN-FIRST:event_gen4CBActionPerformed
        enableAndDisableBoxes();
    }// GEN-LAST:event_gen4CBActionPerformed

    private void gen5CBActionPerformed() {// GEN-FIRST:event_gen5CBActionPerformed
        enableAndDisableBoxes();
