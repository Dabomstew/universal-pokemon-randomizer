...
public class Gen4Constants {
	...
	public static final int chikoritaIndex = 152, cyndaquilIndex = 155,
			totodileIndex = 158, turtwigIndex = 387, chimcharIndex = 390,
			piplupIndex = 393, slowpokeIndex = 79;

	public static final int fossilCount = 7;

	public static final String dpptTMDataPrefix = "D100D200D300D400",
			hgssTMDataPrefix = "1E003200";
	...
	public static final String dpPalettesPrefix = "8D018E01210132018D018F0122013301",
			pthgssPalettesPrefix = "8D018E01210133018D018F0122013401";

	public static final int evolutionMethodCount = 26;

	public static final int waterStoneIndex = 84, leafStoneIndex = 85,
			dawnStoneIndex = 109;
	...
	public static final List<Integer> ptRequiredFieldTMs = Arrays
	...
	public static final List<Integer> dpptFieldMoves = Arrays.asList(15, 19,
			57, 70, 148, 91, 100, 127, 249, 230, 432, 431);

	public static final List<Integer> hgssFieldMoves = Arrays.asList(15, 19,
			57, 70, 148, 91, 100, 250, 127, 249, 29, 230, 431);
	// DPPt: rock smash, cut
	public static final List<Integer> dpptEarlyRequiredHMMoves = Arrays.asList(
			249, 15);
	// HGSS: just cut
	public static final List<Integer> hgssEarlyRequiredHMMoves = Arrays
			.asList(15);
	...
	private static void tagRivalConsecutive(List<Trainer> allTrainers,
			String tag, int offsetFire) {
	...
	private static void tagFriendConsecutive(List<Trainer> allTrainers,
			String tag, int offsetGrass) {
	...
	private static void tagFriendConsecutive2(List<Trainer> allTrainers,
			String tag, int offsetWater) {
