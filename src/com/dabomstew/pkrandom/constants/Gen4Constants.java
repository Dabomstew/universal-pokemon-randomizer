...
public class Gen4Constants {
    ...
    public static final int[] hgssDungeonDexMaps = new int[] {
           -1, -1, -1, -1, -1, -1,  1,  1, -1,  2, // 0-9 (first few cities/routes, sprout tower + alph)
            ...
            5, -1, -1,  6,  6, -1, -1, -1,  7,  7, // 20-29 (ilex, routes, natpark, routes, burned)
    ...
    public static void tagTrainersDP(List<Trainer> trs) {
        ...
        // Gym Leaders
        tagAndMark(trs, true, 0xf6, "GYM1");
        tagAndMark(trs, true, 0x13b, "GYM2");
        tagAndMark(trs, true, 0x13d, "GYM3"); // Maylene
        tagAndMark(trs, true, 0x13c, "GYM4"); // Wake
        tagAndMark(trs, true, 0x13e, "GYM5"); // Fantina
        tagAndMark(trs, true, 0xfa, "GYM6"); // Byron
        tagAndMark(trs, true, 0x13f, "GYM7"); // Candice
        tagAndMark(trs, true, 0x140, "GYM8"); // Volkner
        ...
        tagAndMarkRivalConsecutive(trs, "RIVAL2", 0x1d7);
        tagAndMarkRivalConsecutive(trs, "RIVAL3", 0x1da);
        tagAndMarkRivalConsecutive(trs, "RIVAL4", 0x1dd);
        // Tag battle is not following ze usual format
        tag(trs, 0x26b, "RIVAL5-0");
        tag(trs, 0x26c, "RIVAL5-1");
        tag(trs, 0x25f, "RIVAL5-2");
        // Back to normal
        tagAndMarkRivalConsecutive(trs, "RIVAL6", 0x1e0);
        tagAndMarkRivalConsecutive(trs, "RIVAL7", 0x346);
        tagAndMarkRivalConsecutive(trs, "RIVAL8", 0x349);

        // Themed
        tagAndMark(trs, "THEMED:CYRUS", 0x193, 0x194);
        tag(trs, "THEMED:MARS", 0x127, 0x210); //early mars encounter and tag battle
        tagAndMark(trs, 0x195, "THEMED:MARS");
        tag(trs, "THEMED:JUPITER", 0x196, 0x197);
        tagAndMark(trs, "THEMED:SATURN", 0x198, 0x199);
    ...
    public static void tagTrainersPt(List<Trainer> trs) {
        ...
        tagAndMark(trs, true, 0xf6, "GYM1");
        tagAndMark(trs, true, 0x13b, "GYM2");
        tagAndMark(trs, true, 0x13e, "GYM3"); // Fantina
        tagAndMark(trs, true, 0x13d, "GYM4"); // Maylene
        tagAndMark(trs, true, 0x13c, "GYM5"); // Wake
        tagAndMark(trs, true, 0xfa, "GYM6"); // Byron
        tagAndMark(trs, true, 0x13f, "GYM7"); // Candice
        tagAndMark(trs, true, 0x140, "GYM8"); // Volkner
        ...
        tagAndMarkRivalConsecutive(trs, "RIVAL3", 0x1d7);
        tagAndMarkRivalConsecutive(trs, "RIVAL4", 0x1da);
        tagAndMarkRivalConsecutive(trs, "RIVAL5", 0x1dd);
        // Tag battle is not following ze usual format
        tag(trs, 0x26b, "RIVAL6-0");
        tag(trs, 0x26c, "RIVAL6-1");
        tag(trs, 0x25f, "RIVAL6-2");
        // Back to normal
        tagAndMarkRivalConsecutive(trs, "RIVAL7", 0x1e0);
        tagAndMarkRivalConsecutive(trs, "RIVAL8", 0x346);
        tagAndMarkRivalConsecutive(trs, "RIVAL9", 0x349);
        tagAndMarkRivalConsecutive(trs, "RIVAL10", 0x368);

        // Battleground Gym Leaders
        tagAndMark(trs, true, 0x35A, "GYM1");
        tagAndMark(trs, true, 0x359, "GYM2");
        tagAndMark(trs, true, 0x35C, "GYM3");
        tagAndMark(trs, true, 0x356, "GYM4");
        tagAndMark(trs, true, 0x35B, "GYM5");
        tagAndMark(trs, true, 0x358, "GYM6");
        tagAndMark(trs, true, 0x355, "GYM7");
        tagAndMark(trs, true, 0x357, "GYM8");

        // Match vs Volkner and Flint in Battle Frontier
        tagAndMark(trs, true, 0x399, "GYM8");
        ...
        tag(trs, "THEMED:MARS", 0x127, 0x210); //original encounter and tag battle
        tagAndMark(trs, "THEMED:MARS", 0x195, 0x39e);
        tag(trs, "THEMED:JUPITER", 0x196, 0x197);
        tagAndMark(trs, 0x39f, "THEMED:JUPITER");
        tagAndMark(trs, "THEMED:SATURN", 0x198, 0x199);
    ...
    public static void tagTrainersHGSS(List<Trainer> trs) {
        ...
        // Gym Leaders
        tagAndMark(trs, true, 0x14, "GYM1");
        tagAndMark(trs, true, 0x15, "GYM2");
        tagAndMark(trs, true, 0x1e, "GYM3");
        tagAndMark(trs, true, 0x1f, "GYM4");
        tagAndMark(trs, true, 0x22, "GYM5");
        tagAndMark(trs, true, 0x21, "GYM6");
        tagAndMark(trs, true, 0x20, "GYM7");
        tagAndMark(trs, true, 0x23, "GYM8");

        tagAndMark(trs, true, 0xFD, "GYM9");
        tagAndMark(trs, true, 0xFE, "GYM10");
        tagAndMark(trs, true, 0xFF, "GYM11");
        tagAndMark(trs, true, 0x100, "GYM12");
        tagAndMark(trs, true, 0x101, "GYM13");
        tagAndMark(trs, true, 0x102, "GYM14");
        tagAndMark(trs, true, 0x103, "GYM15");
        tagAndMark(trs, true, 0x105, "GYM16");
        ...
        // Gym Rematches
        tagAndMark(trs, true, 0x2c8, "GYM1");
        tagAndMark(trs, true, 0x2c9, "GYM2");
        tagAndMark(trs, true, 0x2ca, "GYM3");
        tagAndMark(trs, true, 0x2cb, "GYM4");
        tagAndMark(trs, true, 0x2ce, "GYM5");
        tagAndMark(trs, true, 0x2cd, "GYM6");
        tagAndMark(trs, true, 0x2cc, "GYM7");
        tagAndMark(trs, true, 0x2cf, "GYM8");

        tagAndMark(trs, true, 0x2d0, "GYM9");
        tagAndMark(trs, true, 0x2d1, "GYM10");
        tagAndMark(trs, true, 0x2d2, "GYM11");
        tagAndMark(trs, true, 0x2d3, "GYM12");
        tagAndMark(trs, true, 0x2d4, "GYM13");
        tagAndMark(trs, true, 0x2d5, "GYM14");
        tagAndMark(trs, true, 0x2d6, "GYM15");
        tagAndMark(trs, true, 0x2d7, "GYM16");
        ...
        tagAndMark(trs, 0x10a, "RIVAL2-0");
        tagAndMark(trs, 0x10d, "RIVAL2-1");
        tagAndMark(trs, 0x1, "RIVAL2-2");

        tagAndMark(trs, 0x10B, "RIVAL3-0");
        tagAndMark(trs, 0x10E, "RIVAL3-1");
        tagAndMark(trs, 0x107, "RIVAL3-2");

        tagAndMark(trs, 0x121, "RIVAL4-0");
        tagAndMark(trs, 0x10f, "RIVAL4-1");
        tagAndMark(trs, 0x120, "RIVAL4-2");

        tagAndMark(trs, 0x10C, "RIVAL5-0");
        tagAndMark(trs, 0x110, "RIVAL5-1");
        tagAndMark(trs, 0x108, "RIVAL5-2");

        tagAndMarkRivalConsecutive(trs, "RIVAL6", 0x11e);
        tagRivalConsecutive(trs, "RIVAL7", 0x2e0); // dragons den tag battle
        tagAndMarkRivalConsecutive(trs, "RIVAL8", 0x1EA);
    ...
    private static void tagAndMarkRivalConsecutive(List<Trainer> allTrainers, String tag, int offsetFire) {
        tagRivalConsecutive(allTrainers, tag, offsetFire);
        allTrainers.get(offsetFire - 1).giveFullTeam = true;
        allTrainers.get(offsetFire).giveFullTeam = true;
        allTrainers.get(offsetFire - 2).giveFullTeam = true;
