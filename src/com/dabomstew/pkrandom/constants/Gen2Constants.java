...
public class Gen2Constants {
	...
	public static final int bsHPOffset = 1, bsAttackOffset = 2,
			bsDefenseOffset = 3, bsSpeedOffset = 4, bsSpAtkOffset = 5,
	...
	public static final int fishingGroupCount = 12, pokesPerFishingGroup = 11,
			fishingGroupEntryLength = 3, timeSpecificFishingGroupCount = 11,
			pokesPerTSFishingGroup = 4;

	public static final int landEncounterSlots = 7, seaEncounterSlots = 3;

	public static final int gameCornerRepeatPKIndex1 = 0x11,
			gameCornerRepeatPKIndex2 = 0x16;

	public static final int unownIndex = 201, slowpokeIndex = 79,
			seadraIndex = 117, poliwhirlIndex = 61;
	...
	public static final List<Integer> requiredFieldTMs = Arrays
			.asList(new Integer[] { 4, 20, 22, 26, 28, 34, 35, 39, 40, 43, 44,
					46 }), fieldMoves = Arrays.asList(15, 19, 57, 70, 148, 91,
			100, 250, 127, 249, 29, 230), earlyRequiredHMMoves = Arrays
			.asList(15);
	...
	private static void setupAllowedItems() {
		...
		nonBadItems.banSingles(0x1E, 0x23, 0x3C, 0x4B, 0x55, 0x59, 0x61, 0x63,
				0x65, 0x69, 0x76, 0x9E, 0xA3, 0xAD, 0xB4);
	...
	private static void tbc(List<Trainer> allTrainers, int classNum,
