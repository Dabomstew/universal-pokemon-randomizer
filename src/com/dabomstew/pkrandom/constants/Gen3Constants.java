...
public class Gen3Constants {
	...
	public static final int size8M = 0x800000, size16M = 0x1000000,
			size32M = 0x2000000;
	...
	public static final int bsHPOffset = 0, bsAttackOffset = 1,
			bsDefenseOffset = 2, bsSpeedOffset = 3, bsSpAtkOffset = 4,
	...
	public static final int rseStarter2Offset = 2, rseStarter3Offset = 4,
			frlgStarter2Offset = 515, frlgStarter3Offset = 461,
			frlgStarterRepeatOffset = 5;

	public static final int frlgBaseStarter1 = 1, frlgBaseStarter2 = 4,
			frlgBaseStarter3 = 7;
	...
	public static final int unownIndex = 201, slowpokeIndex = 79,
			seadraIndex = 117, poliwhirlIndex = 61, mewIndex = 151,
			clamperlIndex = 366, huntailIndex = 367, gorebyssIndex = 368;

	public static final int tmCount = 50, hmCount = 8;

	public static final List<Integer> hmMoves = Arrays.asList(0xf, 0x13, 0x39,
			0x46, 0x94, 0xf9, 0x7f, 0x123);

	public static final int tmItemOffset = 289;

	public static final int rseItemDescCharsPerLine = 18,
			frlgItemDescCharsPerLine = 24;
	...
	public static final int levelEvoKantoDexJumpAmount = 0x14,
			stoneEvoKantoDexJumpAmount = 0x08;
	...
	public static final int sunStoneIndex = 93, moonStoneIndex = 94,
			waterStoneIndex = 97;
	...
	public static final List<Integer> rsRequiredFieldTMs = Arrays
			.asList(new Integer[] { 1, 2, 6, 7, 11, 18, 22, 23, 26, 30, 37, 48 });

	public static final List<Integer> eRequiredFieldTMs = Arrays
			.asList(new Integer[] { 2, 6, 7, 11, 18, 22, 23, 30, 37, 48 });

	public static final List<Integer> frlgRequiredFieldTMs = Arrays
			.asList(new Integer[] { 1, 2, 7, 8, 9, 11, 12, 14, 17, 18, 21, 22,
					25, 32, 36, 37, 40, 41, 44, 46, 47, 48, 49, 50 });

	public static final List<Integer> rseFieldMoves = Arrays.asList(15, 19, 57,
			70, 148, 91, 100, 127, 249, 230, 291, 290);

	public static final List<Integer> frlgFieldMoves = Arrays.asList(15, 19,
			57, 70, 148, 91, 100, 127, 249, 230);

	public static final List<Integer> rseEarlyRequiredHMMoves = Arrays
			.asList(249);
	...
	private static void tag(List<Trainer> allTrainers, String tag,
			int... numbers) {
		for (int num : numbers) {
