...
public class Gen5Constants {
	...
	public static final int bsHPOffset = 0, bsAttackOffset = 1,
			...
			bsDarkGrassHeldItemOffset = 16, bsGrowthCurveOffset = 21,
			bsAbility1Offset = 24, bsAbility2Offset = 25,
	...
	public static final int b2Route4EncounterFile = 104,
			b2VRExclusiveRoom1 = 71, b2VRExclusiveRoom2 = 73,
	...
	public static final int tmCount = 95, hmCount = 6, tmBlockOneCount = 92,
			tmBlockOneOffset = 328, tmBlockTwoOffset = 618;
	...
	public static final int bw2MoveTutorCount = 60,
			bw2MoveTutorBytesPerEntry = 12;

	public static final int evolutionMethodCount = 27;

	public static final int slowpokeIndex = 79, karrablastIndex = 588,
			shelmetIndex = 616;
	...
	public static final int normalItemSetVarCommand = 0x28,
			hiddenItemSetVarCommand = 0x2A, normalItemVarSet = 0x800C,
	...
	public static final List<Integer> bw1RequiredFieldTMs = Arrays
			.asList(new Integer[] { 2, 3, 5, 6, 9, 12, 13, 19, 22, 24, 26, 29,
					30, 35, 36, 39, 41, 46, 47, 50, 52, 53, 55, 58, 61, 63, 65,
					66, 71, 80, 81, 84, 85, 86, 90, 91, 92, 93 });

	public static final List<Integer> bw2RequiredFieldTMs = Arrays
			.asList(new Integer[] { 1, 2, 3, 5, 6, 12, 13, 19, 22, 26, 28, 29,
					30, 36, 39, 41, 46, 47, 50, 52, 53, 56, 58, 61, 63, 65, 66,
					67, 69, 71, 80, 81, 84, 85, 86, 90, 91, 92, 93 });

	public static final List<Integer> bw1EarlyRequiredHMMoves = Arrays
			.asList(15);
	...
	private static void tagRivalBW(List<Trainer> allTrainers, String tag,
			int offset) {
