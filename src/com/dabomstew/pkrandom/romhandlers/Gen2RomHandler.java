...
public class Gen2RomHandler extends AbstractGBRomHandler {
	...
	private static void setupAllowedItems() {
		...
		nonBadItems.banSingles(0x1E, 0x23, 0x3C, 0x4A, 0x4B, 0x55, 0x59, 0x61,
				0x63, 0x65, 0x69, 0x6D, 0x76, 0x9E, 0xA3, 0xB4);
		nonBadItems.banRange(0x4E, 3);
		nonBadItems.banRange(0x53, 2);
		nonBadItems.banRange(0x5C, 2);
		nonBadItems.banRange(0xA7, 2);
		nonBadItems.banRange(0xAD, 2);
