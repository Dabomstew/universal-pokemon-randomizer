...
public class CodeTweaksDialog extends javax.swing.JDialog {
	...
	private void initialState(int available) {
		...
		pcPotionCB.setVisible((available & CodeTweaks.RANDOMIZE_PC_POTION) > 0);
	}
	...
	private void restoreFrom(int current) {
		...
		pcPotionCB.setSelected((current & CodeTweaks.RANDOMIZE_PC_POTION) > 0);
	}
	...
	public int getChoice() {
		...
		if (pcPotionCB.isSelected()) {
			choice |= CodeTweaks.RANDOMIZE_PC_POTION;
		}
		return choice;
	}
    ...
    private void initComponents() {
        ...
        pcPotionCB = new javax.swing.JCheckBox();
        ...
        fastestTextCB.setText(bundle.getString("CodeTweaksDialog.fastestTextCB.text")); // NOI18N
        fastestTextCB.setToolTipText(bundle.getString("CodeTweaksDialog.fastestTextCB.toolTipText")); // NOI18N

        runningShoesCB.setText(bundle.getString("CodeTweaksDialog.runningShoesCB.text")); // NOI18N
        runningShoesCB.setToolTipText(bundle.getString("CodeTweaksDialog.runningShoesCB.toolTipText")); // NOI18N

        pcPotionCB.setText(bundle.getString("CodeTweaksDialog.pcPotionCB.text")); // NOI18N
        pcPotionCB.setToolTipText(bundle.getString("CodeTweaksDialog.pcPotionCB.toolTipText")); // NOI18N
    ...
    private javax.swing.JCheckBox pcPotionCB;
